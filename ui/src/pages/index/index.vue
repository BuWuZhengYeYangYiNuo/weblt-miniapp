<template>
  <div class="login-page">
    ...
    >
      <!-- bubble="true" 阻止父级 scroller 吞掉 click 事件 -->
      <div class="login-field" @click="focusField('username')" bubble="true">
      ...
      <div class="login-field" @click="focusField('password')" bubble="true">
